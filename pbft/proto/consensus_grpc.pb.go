...
const (
	Consensus_SendMessage_FullMethodName = "/consensus.Consensus/SendMessage"
)
...
func (c *consensusClient) SendMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Ack, error) {
...
func (UnimplementedConsensusServer) SendMessage(context.Context, *Message) (*Ack, error) {
...
func _Consensus_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsensusServer).SendMessage(ctx, req.(*Message))
	}
